...
<div id="edd_checkout_cart" <?php if ( ! edd_is_ajax_disabled() ) { echo 'class="ajaxed"'; } ?>>
    ...
    <?php if (edd_use_taxes() && ! edd_prices_include_tax()) : ?>
        <div class="edd_cart_footer_row edd_cart_subtotal_row row"<?php if ( ! edd_is_cart_taxed() ) echo ' style="display:none;"'; ?>>
    ...
    <?php if (edd_use_taxes()) : ?>
        <div class="edd_cart_footer_row edd_cart_tax_row row"<?php if ( ! edd_is_cart_taxed() ) echo ' style="display:none;"'; ?>>
    ...
    <div class="edd_cart_footer_row">
        ...
        <div class="edd_cart_total row">
            <div class=" col-xs-9"><?php _e('Total', 'easy-digital-downloads'); ?>:</div>
