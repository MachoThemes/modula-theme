...
<?php get_template_part( 'assets/images/illustration-9.svg' ); ?>
<div class="illustration illustration-9">
	<div class="illustration__content">
		<svg class="illustration-9__static" viewBox="0 0 100 100"><use xlink:href="#illustration-9__static"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-3" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-3"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-4" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-4"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-5" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-5"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-6" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-6"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-7" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-7"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-8" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-8"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-9" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-9"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-10" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-10"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-11" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-11"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-12" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-12"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-13" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-13"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-14" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-14"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-1" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-1"></use></svg>
		<svg class="illustration__animated-svg illustration-9__leaf-2" viewBox="0 0 100 100"><use xlink:href="#illustration-9__leaf-2"></use></svg>
	</div>
</div>


<?php get_template_part( 'assets/images/illustration-10.svg' ); ?>
<div class="illustration illustration-10">
	<div class="illustration__content">
		<svg class="illustration__animated-svg illustration-10__leaf-1" viewBox="0 0 100 100"><use xlink:href="#illustration-10__leaf-1"></use></svg>
		<svg class="illustration__animated-svg illustration-10__leaf-2" viewBox="0 0 100 100"><use xlink:href="#illustration-10__leaf-2"></use></svg>
		<svg class="illustration__animated-svg illustration-10__leaf-3" viewBox="0 0 100 100"><use xlink:href="#illustration-10__leaf-3"></use></svg>
	</div>
</div>
