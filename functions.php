...
}//end jp_disable_billing_details()
...
}//end modula_licenses_tag()

// Customizing the EDD checkout page
add_filter('edd_checkout_personal_info_text', 'modula_checkout_personal_info_text');


function modula_checkout_personal_info_text() {
	return esc_html__('Fill in Your Account Details', 'modula-theme');
}
