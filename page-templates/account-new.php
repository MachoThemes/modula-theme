                        ...
                        <div class="tab-pane fade" id="downloads" role="tabpanel" aria-labelledby="downloads-tab">
                            ...
                            <thead>
                                <tr class="edd_download_history_row">
                                    ...
                                    <th class="edd_download_download_files"><?php _e( 'Support', 'modula-theme' ); ?></th>
                                </tr>
                            </thead>
                            <?php if ( $purchases ) :
                                    ...
                                    if ( $downloads ) :
                                        foreach ( $downloads as $download ) :
                                            ...
                                            <tr class="edd_download_history_row">
                                                ...
                                                <td>
                                                <a href="/contact-us" target="_blank"><?php _e('Support', 'modula-theme') ?></a>
                                                </td>
                                            </tr>
                                            <?php
                                            endif;
