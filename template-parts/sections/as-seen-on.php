<section class="as-seen-on-section">
	<div class="container">
		...
		<div class="row">
			<div class="section__heading text-center col-md-8 col-md-offset-2">
				<h3>As Seen On</h3>
			</div>
		</div>
		...
		<div class="row as-seen-on-section__images">
			<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 mb-3">
				<div class="as-seen-on-section__images__img">
					<?php echo file_get_contents( get_template_directory_uri() . '/assets/images/logos/colorlib.svg' ); ?>
				</div>
			</div>
			<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 mb-3">
				<div class="as-seen-on-section__images__img">
			...
			<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 mb-3">
				<div class="as-seen-on-section__images__img">
					<?php echo file_get_contents( get_template_directory_uri() . '/assets/images/logos/codeinwp.svg' ); ?>
				</div>
			</div>
		</div>
