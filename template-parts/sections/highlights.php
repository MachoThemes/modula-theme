		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="section__heading text-center">
					<h3>Finally, there's way to build great galleries without touching code</h3>
					<p>We have extensions for every feature a professional photographer could need</p>
				</div>
				...
				<div class="text-center col-lg-12 text-center mt-lg-3">
					...
					<div>
						<small class="cta_money_back_guarantee" style="font-size: 13px; position:relative;top: -15px;">14 day money back guarantee, love it or get a full refund.</small>
					</div>
				</div>

				</div><!-- /.row/.hightlights-section-wrap -->
			</div><!-- /.col-xs-12/-->
		</div><!-- /.row -->
	</div><!-- container -->
</section>
