    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 text-center text-md-left m-0 p-0 mb-xs-3 mb-md-0">
                ...
                <p>Modula is fully customizable <u>without touching a single line of code, does not slow down your website and is fully mobile responsive!</u></p>
                ...
                <div><small class="cta_money_back_guarantee" style="font-size: 13px; position:relative;top: -15px;">14 day money back guarantee, love it or get a full refund.</small></div>
            </div>
