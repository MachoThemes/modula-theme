...
?>
	<div class="container main-table">
			<div class="plans-table row">
                <?php foreach ( $downloads as $download ) : ?>
                    <div class="col-md-4 plan">
                        ...
                        <?php if ( $upgrading && $download->higher_plan ) : ?>
                                <a class="button plans-table__button plans-table__button" href="<?php echo esc_url( edd_sl_get_license_upgrade_url( $license_by_key->ID, $download->upgrade_id ) ); ?>" title="Upgrade">Upgrade</a>
                        <?php else : ?>
                        ...
                        <div class="plans-table__content">
                            ...
                            <div class="compare-plans-button">
                                <a class="compare-plans-button" href="/pricing"><?php _e('Compare all plans', 'modula-theme'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
		...
		<section class="section testimonials-section-3">
			<div class="col-xs-12">
				<div class="testimonial-section-3 mb-3">
					<div class="testimonial__stars mb-3"></div>
					<div class="testimonial__content mb-3 col-sm-8">
					...
					<div class="testimonial__author col-sm-4">
