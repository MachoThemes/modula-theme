<section class="promotion-section text-center" style="display:none">
    <span>Enjoy our <strong>Black Friday</strong> offer for <strong>Modula</strong>, get <strong>30% OFF</strong>. The promotion ends in: </span><span class="timer"><span class="days"></span> : <span class="hours"></span> : <span class="minutes"></span> : <span class="seconds"></span></span>
</section>
