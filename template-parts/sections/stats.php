<section class="section stats-section">
	<div class="container">
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6">
				<h3 style="margin-bottom:2rem">Active community of users and developers.</h3>
				<p style="margin-bottom:2rem">Meet the <strong>fastest</strong> and most <strong>user-friendly</strong> WordPress gallery plugin available.</p>
				<div class="row">
