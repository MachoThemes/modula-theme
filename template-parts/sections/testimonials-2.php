                ...
                <div class="testimonials-section-2__testimonials row">
                    <div class="col-sm-6 col-lg-4 mb-3">
                        <div class="testimonial mb-3">
                            ...
                            <div class="testimonial__content mb-3">
                                <p class="mb-0">Modula is one of the leading gallery plugins in the WordPress economy
                    ...
                    <div class="col-sm-6 col-lg-4 mb-3">
                        <div class="testimonial">
                            <div class="testimonial__stars mb-3"></div>
                            <div class="testimonial__content mb-3">
                                <p class="mb-0">Modula is an excellent solution for photographers wanting an attractive,
                                    feature-packed and easy-to-use gallery to display their work.</p>
                            </div>
                            <div class="testimonial__author">
                    ...
                    <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                        <div class="testimonial">
                            <div class="testimonial__stars mb-3"></div>
                            <div class="testimonial__content mb-3">
                                <p class="mb-0">Before using Modula, all gallery plugins I tested lacked something.
                                    Modula was the first to combine custom grid layouts with easy image sizing and
                                    stunning responsiveness with a gallery that doesn't impact the loading speed of my
                                    website.</p>
                            </div>
                            <div class="testimonial__author">
