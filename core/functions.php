...
function modula_header_class() {
	...
	if ( is_home() || is_archive() || ( is_page() && ! is_page_template( 'page-templates/pricing.php' ) && ! is_page_template( 'page-templates/pricing-2.php' ) && ! is_page_template( 'page-templates/pricing-ltd.php' ) && ! is_page_template( 'page-templates/checkout.php' ) && ! is_page_template( 'page-templates/account.php' ) && ! is_page_template( 'page-templates/purchase-confirmation.php' ) && ! is_page_template( 'page-templates/landing-page-2.php' ) ) ) {
...
function modula_footer() {
	...
	if ( is_page( 'pricing' ) || ( is_singular( 'post' ) ) ) {
...
function modula_checkout_redirect() {
	...
	if ( is_page_template( 'page-templates/checkout.php' ) && function_exists( 'edd_get_cart_contents' ) && ! edd_get_cart_contents() ) {
