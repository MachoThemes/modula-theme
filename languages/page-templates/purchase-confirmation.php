	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h3 class="mt-3">Installation Instructions</h3>
					...
					<!-- 	<p>Installation Method #1:</p> -->
						<ul class="list--checkmark">
							...
							<li>Select the plugin zip file (modula.x.x.x.zip) from your computer then click the <strong>Install Now</strong> button.</li>
				...
				<!-- 	<div class="col-md-6">
						...
						<ul class="list--checkmark">
							...
							<li>Copy the <strong>modula</strong> folder into the <strong>/wp-content/plugins</strong> directory of your WordPress installation.</li>
							<li>Login to your website and go to the Plugins section of your admin panel.</li>
							<li>Look for <strong>Modula Grid Gallery</strong> and click <strong>Activate</strong>.</li>
						</ul>
					</div> -->
