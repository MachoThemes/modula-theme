		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="rounded-box">
					...
					<p><small>If you've paid with a Credit Card, cancelling your subscription through Easy Digital Downloads (the software we use to power our shop) isn't possible automatically.<br/>Send us an email to: <a href = "mailto:hello@wp-modula.com">hello@wp-modula.com</a> and we'll get it sorted in less than 24h.</small></p>
				</div>
			</div>
			<div class="col-xs-12">
				<div class="rounded-box">
